  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Logística para comercialización de productos
        p.mb-4 Asociar conceptos relacionados a la logística operacional, clasificación y normatividad de mercancías.
